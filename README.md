...
The server URL must be an absolute URL to the PowerDNS API including the scheme (for example, `http://pdns:8081` or `https://powerdns.example.com`), without a query string or fragment.
